...
Java_com_example_even_1realities_1g1_1example_cpp_Cpp_decodeLC3(JNIEnv *env, jclass instance, jbyteArray lc3Data) {
...
Java_com_example_even_1realities_1g1_1example_cpp_Cpp_rnNoise(JNIEnv *env, jclass clazz,jlong st, jfloatArray input) {
...
Java_com_example_even_1realities_1g1_1example_cpp_Cpp_createRNNoiseState(JNIEnv *env, jclass clazz) {
    return (jlong) rnnoise_create(NULL);
}

extern "C" JNIEXPORT void JNICALL
Java_com_example_even_1realities_1g1_1example_cpp_Cpp_destroyRNNoiseState(JNIEnv *env, jclass clazz, jlong st) {
